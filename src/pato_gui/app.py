...
def check_environment():
    ...
    PYTHONPATH = os.environ['PYTHONPATH'] if 'PYTHONPATH' in os.environ.keys() else ''
    logger.info(f"Environment variable PYTHONPATH: {PYTHONPATH}")
...
@Gooey(program_name='environment',
       program='Get POM file',
